  ...
  return (
    ...
    >
      ...
      <div className="flex flex-1 flex-col px-3 pb-4 pt-3 text-slate-900 sm:px-4 sm:pb-5 sm:pt-4">
        ...
        <div className="mb-2 text-[10px] font-semibold uppercase tracking-[0.14em] text-slate-400 sm:text-[11px] sm:tracking-[0.16em]">
          Oferta valida para compras online
        </div>

        <Link href={`/produto/${produto.id}`} className="block">
          <h3 className="line-clamp-3 min-h-[3.8rem] text-sm font-black leading-tight text-slate-900 sm:min-h-[4.8rem] sm:text-[1.05rem]">
            {produto.nome}
          </h3>
        </Link>

        <div className="mt-3 rounded-[18px] border border-slate-100 bg-[linear-gradient(180deg,#ffffff_0%,#f8fafc_100%)] p-3 shadow-inner shadow-slate-100/70 sm:mt-4 sm:rounded-[22px] sm:p-4">
          ...
          <div className="mt-2 text-[11px] font-bold text-primary sm:mt-3 sm:text-sm">
            Oferta valida para compras online
          </div>
          <div className="mt-2 text-[11px] font-semibold text-slate-700 sm:text-sm">
            ou {parcelamento} sem juros no valor cheio
          </div>
        </div>

        <div className="mt-3 rounded-xl border border-emerald-100 bg-emerald-50/70 px-3 py-2 text-[10px] font-bold uppercase tracking-[0.14em] text-emerald-700 sm:mt-4 sm:rounded-2xl sm:text-[11px] sm:tracking-[0.16em]">
