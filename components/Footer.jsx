        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="lg:col-span-2">
            <div className="flex items-center gap-2.5 mb-3">
              <div className="w-10 h-10 bg-primary rounded flex items-center justify-center font-display text-white text-xl leading-none">G</div>
              <div>
                <div className="text-white font-display text-lg uppercase tracking-wide">Galpão do Aço</div>
                <div className="text-[10px] text-gray-500 uppercase tracking-widest">Material de Construção</div>
              </div>
            </div>
            <p className="text-sm leading-relaxed text-gray-500 max-w-xs mb-4">
              A solução certa para sua obra! Qualidade, variedade e os melhores preços em Boa Vista/RR.
            </p>
            {/* Instagram */}
