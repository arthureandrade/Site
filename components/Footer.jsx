...
export default function Footer() {
  ...
  return (
    <footer className="mt-auto border-t-2 border-primary bg-[linear-gradient(180deg,#091224_0%,#111827_100%)] text-slate-400">
        ...
        <div className="grid grid-cols-1 gap-10 sm:grid-cols-2 lg:grid-cols-4">
          <div className="lg:col-span-2">
            ...
            <div className="mb-5 space-y-2 text-sm">
              <div className="inline-flex rounded-full border border-primary/20 bg-primary/10 px-3 py-1 text-[11px] font-black uppercase tracking-[0.22em] text-primary">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><Link href="/politica-de-privacidade" className="transition-colors hover:text-white">Política de privacidade</Link></li>
          ...
          <div id="contato">
            <h4 className="mb-4 text-[11px] font-black uppercase tracking-[0.24em] text-white">Contato</h4>
