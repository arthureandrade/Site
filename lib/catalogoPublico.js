...
export const SECOES_CATALOGO = [
  {
    nome: 'Aço, Telhas e Estruturas',
    grupos: [3, 5, 6, 7, 8, 15, 16, 18, 19, 20, 26, 38, 39, 50, 60, 65, 78, 79, 80, 81, 84, 85, 87, 91, 98, 103],
  },
  {
  ...
  {
    nome: 'Ferramentas, Máquinas e Solda',
    grupos: [10, 21, 24, 29, 30, 33, 35, 36, 42, 43, 44, 45, 58, 93, 102],
  },
  {
  ...
  {
    nome: 'Casa, Jardim e Utilidades',
    grupos: [9, 12, 13, 14, 17, 31, 34, 48, 54, 56, 61, 62, 63, 66, 76, 77, 86, 88, 89, 90, 92, 94, 95, 96, 97, 99, 101, 104, 9999],
  },
]

const SECAO_PADRAO_CATALOGO = 'Casa, Jardim e Utilidades'
const ORDEM_SECOES_CATALOGO = new Map(SECOES_CATALOGO.map((secao, index) => [secao.nome, index]))
...
export function inferirCategoriaProduto(produto) {
  return inferirSecaoPorTexto(produto) || inferirSecaoPorGrupo(produto) || SECAO_PADRAO_CATALOGO
}
...
const BONUS_SECAO_CATALOGO = {
  ...
  'Ferramentas, Máquinas e Solda': 32,
  'Aço, Telhas e Estruturas': 30,
  'Hidráulica, Elétrica e Iluminação': 22,
  'Acabamento, Pintura e Químicos': 20,
  'Casa, Jardim e Utilidades': 10,
}
